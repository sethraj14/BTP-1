      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"> <a href="forms.php"> <i class="icon-padnote"></i>New Train</a></li>
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Schedule New Train</h2>
            </div>
          </header>
          <ul class="breadcrumb">
            <div class="container-fluid">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">New Train</li>
            </div>
          </ul>
          <!-- Forms Section-->
          <section class="forms"> 
              ...
              <!-- <div class="row"> -->
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Train Information</h3>
                    </div>
                    <div class="card-body">
                      <p>Provide Information about the new Train.</p>
                      <form class="form-horizontal">
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Train Number</label>
                          <div class="col-sm-9">
                            <input id="train_no" type = "number"  placeholder="Train No." class="form-control form-control-success"><small class="form-text">Eg : 12541.</small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Train Name</label>
                          <div class="col-sm-9">
                            <input id="train_name"   placeholder="name of the train" class="form-control form-control-warning"><small class="form-text">Eg : Taj Express.</small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input id="source" type = "text"   placeholder="source of the new train" class="form-control form-control-success"><small class="form-text">Eg : Patna.</small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input id="destination" type = "text" placeholder="Destination of the new train" class="form-control form-control-success"><small class="form-text">Eg : Mughalsarai Junction.</small>
                          </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Type of the Train</label>
                          <div class="col-sm-9">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Days of Run <br></label>
                          <div class="col-sm-9">
                            <div class="i-checks">
                              <input id="radioCustom1" type="radio"  checked="true" value="option1" name="Mon" class="radio-template">
                              <label for="radioCustom1">Monday</label>
                            </div>
                            <div class="i-checks">
                              <input id="radioCustom2" type="radio"  checked="" value="option2" name="Tue" class="radio-template">
                              <label for="radioCustom2">Tuesday</label>
                            </div>
                            <div class="i-checks">
                              <input id="radioCustom3" type="radio"  checked="" value="option1" name="Wed" class="radio-template">
                              <label for="radioCustom3">Wednesday</label>
                            </div>
                            <div class="i-checks">
                              <input id="radioCustom4" type="radio"  checked="" value="option2" name="Thu" class="radio-template">
                              <label for="radioCustom4">Thursday</label>
                            </div>
                            <div class="i-checks">
                              <input id="radioCustom5" type="radio"  checked="" value="option1" name="Fri" class="radio-template">
                              <label for="radioCustom5">Friday</label>
                            </div>
                            <div class="i-checks">
                              <input id="radioCustom6" type="radio"  checked="" value="option2" name="Sat" class="radio-template">
                              <label for="radioCustom6">Saturday</label>
                            </div>
                            <div class="i-checks">
                              <input id="radioCustom7" type="radio"    checked="" value="option1" name="Sun" class="radio-template">
                              <label for="radioCustom7">Sunday</label>
                            </div>
                          </div>
                        </div>
                        <div class="line"></div>
